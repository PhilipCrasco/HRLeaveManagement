...
namespace Application.Features.Leave_Request.Handler.Queries
{
    public class Get_Leave_Request_Details_Request_Handler : IRequestHandler<Get_Leave_Request_Details_Request, Leave_Request_Dto>
    {
        ...
        private readonly ILeave_Request_Repository _Leave_Request_Repository;
        private readonly IMapper _mapper;

        public Get_Leave_Request_Details_Request_Handler( ILeave_Request_Repository leave_Request , IMapper mapper)
        {
        ...
        {
            var leave_request = await _Leave_Request_Repository.Get(request.Id);
